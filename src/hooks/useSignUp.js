...
const scheme = yup.object().shape({
  ...
  number: yup
    ...
    }) //Transform the value to null if it's "".
    .integer('O número deve ser um inteiro.')
    .min(10000000000, 'Informe um número válido.')
    .max(99999999999, 'Informe um número válido.')
...
export default function useSignUp() {
  ...
  */
  ...
  return [userInputs, setUserInputs, errors, setErrors, checkSignUp];
}
